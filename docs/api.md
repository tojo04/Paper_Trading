...
The examples freeze envelope shapes for later phases; they are not all implemented in Phase 1.
Money is encoded as a decimal string at the Node/C++ JSON boundary so JavaScript cannot lose 64-bit
integer precision.
...
```json
{"protocolVersion":1,"commandId":"891a9784-a88e-4911-bfde-0394c3250392","type":"CANCEL_ORDER","payload":{"orderId":"ord-101"}}
{"protocolVersion":1,"commandId":"891a9784-a88e-4911-bfde-0394c3250392","accepted":true,"result":{"orderId":"ord-101","status":"CANCELLED","remainingQuantity":"10","engineSequence":"905","fills":[]}}
```

```json
{"protocolVersion":1,"commandId":"2c3c4348-59bf-4273-9cc6-c22391da49ac","type":"PING","payload":{}}
{"protocolVersion":1,"commandId":"2c3c4348-59bf-4273-9cc6-c22391da49ac","accepted":true,"result":{"ready":true}}
```
